...
public class Limo
{
	...
	*/
	...
	public String toString()
	{
		...
		{
			return String.format("%1$s:%2$s; Passenger:%3$s; Dest:%4$s; PathLength:%5$s", getMapPosition(), getAngle(), getPassenger() == null ? "{none}" : getPassenger().getName(), getPassenger().getDestination(), getPath().size());
		}
